...
public class CiCustomGroupInfo implements Serializable, Cloneable {
	...
	private String dataSource = "1000";

	private String dataSourceStr;

	private String searchId;

	private String isActUse;
	...
	private String customGroupIds;

	private String groupIds;

	private Integer isTactic;
	...
	public CiCustomGroupInfo(String customGroupId, String customGroupName, String customGroupDesc,
			String parentCustomId, Integer updateCycle, Integer createTypeId, String createUserId, Date createTime,
			String prodOptRuleShow, String labelOptRuleShow, String customOptRuleShow, String kpiDiffRule,
			Integer status, Integer dataStatus, Date startDate, Date endDate, Long customNum, Date dataTime,
			String dataDate, String templateId, Integer productAutoMacthFlag, Integer isPrivate, String createCityId,
			Date newModifyTime, Integer isLabelOffline, Integer isSysRecom, Integer isContainLocalList,
			String dataSource) {
	...
	public String toString() {
		return "CiCustomGroupInfo [customGroupId=" + this.customGroupId + ", customGroupName=" + this.customGroupName
				+ ", customGroupDesc=" + this.customGroupDesc + ", parentCustomId=" + this.parentCustomId
				+ ", updateCycle=" + this.updateCycle + ", createTypeId=" + this.createTypeId + ", createUserId="
				+ this.createUserId + ", createTime=" + this.createTime + ", prodOptRuleShow=" + this.prodOptRuleShow
				+ ", labelOptRuleShow=" + this.labelOptRuleShow + ", customOptRuleShow=" + this.customOptRuleShow
				+ ", kpiDiffRule=" + this.kpiDiffRule + ", status=" + this.status + ", dataStatus=" + this.dataStatus
				+ ", startDate=" + this.startDate + ", endDate=" + this.endDate + ", customNum=" + this.customNum
				+ ", dataTime=" + this.dataTime + ", dataDate=" + this.dataDate + ", templateId=" + this.templateId
				+ ", productAutoMacthFlag=" + this.productAutoMacthFlag + "]";
	}
	...
	private void initCiCustomListInfo() {
		...
		List<CiCustomListInfo> list = (List<CiCustomListInfo>) cache.get("CI_CUSTOM_LIST_INFO_MAP", getCustomGroupId(),
				List.class);
		if (list != null) {
			for (CiCustomListInfo listInfo : list) {
				if (listInfo.getDataStatus().intValue() == 3) {
					addSuccessList(listInfo);
					continue;
				}
				if (listInfo.getDataStatus().intValue() == 0) {
					this.failedListCount++;
					continue;
				}
	...
	public String getCustomGroupIds() {
		return this.customGroupIds;
	}

	public void setCustomGroupIds(String customGroupIds) {
	...
	public String getIsActUse() {
		return this.isActUse;
	}

	public void setIsActUse(String isActUse) {
		this.isActUse = isActUse;
	}
