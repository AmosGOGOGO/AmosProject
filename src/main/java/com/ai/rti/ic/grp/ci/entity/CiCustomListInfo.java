...
public class CiCustomListInfo implements Serializable, Cloneable {
	...
	public String toString() {
		return "CiCustomListInfo [listTableName=" + this.listTableName + ", dataDate=" + this.dataDate
				+ ", customGroupId=" + this.customGroupId + ", customNum=" + this.customNum + ", ringNum="
				+ this.ringNum + ", dataStatus=" + this.dataStatus + ", dataTime=" + this.dataTime + ", excpInfo=...]";
	}
	...
	public Integer getDecrementNum() {
		return this.decrementNum;
	}

	public void setDecrementNum(Integer decrementNum) {
