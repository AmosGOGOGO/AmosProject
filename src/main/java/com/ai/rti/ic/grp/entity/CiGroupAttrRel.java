   ...
   implements Serializable
 {
   ...
   public CiGroupAttrRel(CiGroupAttrRelId id, String attrColName, String attrColType, int attrSource, String labelOrCustomId, String labelOrCustomColumn, String customName, String customId, String columnName) {
     this.id = id;
