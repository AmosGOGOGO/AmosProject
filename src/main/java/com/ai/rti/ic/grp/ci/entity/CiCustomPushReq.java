...
public class CiCustomPushReq implements Serializable, Cloneable {
	...
	public String toString() {
		return "CiCustomPushReq [reqId=" + this.reqId + ", userId=" + this.userId + ", listTableName="
				+ this.listTableName + ", sysId=" + this.sysId + ", status=" + this.status + ", reqTime=" + this.reqTime
				+ ", startTime=" + this.startTime + ", endTime=" + this.endTime + ", exeInfo=" + this.exeInfo + "]";
	}

	public CiCustomPushReq clone() throws CloneNotSupportedException {
