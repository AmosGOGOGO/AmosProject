 ...
 public class CommonConstants
 {
   ...
   public static final String PD_LIST_TMP_TABLE = "PD_LIST_TMP_TABLE";
 
 
 
 
   
   public static final String CUST_LIST_TMP_TABLE_NEW = "CUST_LIST_TMP_TABLE_NEW";
 
 
 
   
   public static final String PD_LIST_TMP_TABLE_NEW = "PD_LIST_TMP_TABLE_NEW";
   ...
   public static final String TABLE_DIM_CUSTOM_BATCH_IMP_STATUS = "DIM_CUSTOM_BATCH_IMP_STATUS";
   ...
   public static final String TABLE_DIM_DB_DATA_TYPE = "DIM_DB_DATA_TYPE";
   
   public static final String DIM_COC_OBJECT_TYPE = "DIM_COC_OBJECT_TYPE";
   ...
   public static final Integer CUSTOM_GROUP_BELONG_USER = Integer.valueOf(0);
   
   public static final Integer CUSTOM_GROUP_BELONG_CUSTOM = Integer.valueOf(1);
